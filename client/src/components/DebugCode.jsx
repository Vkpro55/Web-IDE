...
const GEMINI_API_KEY = 'AIzaSyBsUWonB3-qhuxVSVnYdH8-YAAgIok7K-I';
  ...
  return (
    <form onSubmit={handleSubmit} className="mt-4">
      <div className="flex">
        <input
          type="text"
          className="w-full px-3 py-2 bg-neutral-700 text-white rounded-l"
        ...
        <button
          type="submit"
          className="bg-[#00aaff] text-neutral-800 font-semibold py-2 px-4 rounded-r"
        >
          Send
        </button>
      </div>
